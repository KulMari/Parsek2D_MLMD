...
mpirun -hostfile $PBS_NODEFILE -n 8 -x LD_LIBRARY_PATH /home/beck/Parsek2D-multilevel/ParsekEM /home/beck/Parsek2D-multilevel/inputfiles/inputfile.vacuum-2grids-test-lynx
