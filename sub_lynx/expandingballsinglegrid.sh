...
mpirun -hostfile $PBS_NODEFILE -n 64 -x LD_LIBRARY_PATH /home/beck/Parsek2D-multilevel/ParsekEM /home/beck/Parsek2D-multilevel/inputfiles/inputfile.expandingballsinglegrid
