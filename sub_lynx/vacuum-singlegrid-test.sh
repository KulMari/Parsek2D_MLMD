...
##mpirun -f $PBS_NODEFILE -n 16 /home/beck/Parsek2D-multilevel/ParsekEM /home/beck/Parsek2D-multilevel/inputfiles/inputfile.vacuum-singlegrid-test-lynx
...
mpirun -hostfile $PBS_NODEFILE -n 16 -x LD_LIBRARY_PATH /home/beck/Parsek2D-multilevel/ParsekEM /home/beck/Parsek2D-multilevel/inputfiles/inputfile.vacuum-singlegrid-test-lynx
