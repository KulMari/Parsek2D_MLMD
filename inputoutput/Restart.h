...
inline void writeRESTART(string SaveDirName, int myrank, int cycle, int ns, MPIdata *mpi, VCtopology *vct, Collective *col, Grid *grid, Field *field, Particles2Dcomm *part){
...
inline void writeRESTART(string SaveDirName, int myrank, int cycle, int ns, MPIdata *mpi, VCtopology *vct, Collective *col, Grid *grid, Field *field, Particles2Dcomm *part, bool fool){
  // Create an Output Manager
  PSK::OutputManager< PSK::OutputAdaptor > output_mgr;
  // Create an Output Agent for HDF5 output
  myOutputAgent< PSK::HDF5OutputAdaptor > hdf5_agent;
...
/** write the restart file at any RESTART_CYCLE, useful for reading intermediate results */
inline void writeRESTART_ES(string SaveDirName, int myrank, int cycle, int ns, MPIdata *mpi, VCtopology *vct, Collective *col, Grid *grid, Field *field, Particles *part){
  // Create an Output Manager
  PSK::OutputManager< PSK::OutputAdaptor > output_mgr;
  // Create an Output Agent for HDF5 output
  myOutputAgent< PSK::HDF5OutputAdaptor > hdf5_agent;
...
/** this restart function writes the last restart with the last cycle */
inline void writeRESTART_ES(string SaveDirName, int myrank, int cycle, int ns, MPIdata *mpi, VCtopology *vct, Collective *col, Grid *grid, Field *field, Particles *part, bool fool){
  // Create an Output Manager
  PSK::OutputManager< PSK::OutputAdaptor > output_mgr;
  // Create an Output Agent for HDF5 output
  myOutputAgent< PSK::HDF5OutputAdaptor > hdf5_agent;
