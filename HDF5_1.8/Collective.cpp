/***************************************************************************
                          Collective.h  -  description
                             -------------------
    begin                : Wed Jun 8 2011
    copyright            : (C) 2011 K.U. LEUVEN
    developers           : Pierre Henri, Stefano Markidis
    email                : pierre.henri@wis.kuleuven.be
 ***************************************************************************/
...
int Collective::ReadRestart(string inputfile){
	...
	name_species[i] = "/collective/species_"+ ss[i].str() +"/";
     ...
     for(int i=0;i < ns;i++){
         dataset_id = H5Dopen1(file_id, (name_species[i]+"Npcelx").c_str());  //--- HDF5 1.8
     ...
     for(int i=0;i < ns;i++){
         dataset_id = H5Dopen1(file_id, (name_species[i]+"Npcely").c_str());  //--- HDF5 1.8
     ...
     for(int i=0;i < ns;i++){
         dataset_id = H5Dopen1(file_id, (name_species[i]+"qom").c_str());  //--- HDF5 1.8
    ...
    dataset_id = H5Dopen1(file_id, "/last_cycle");  //--- HDF5 1.8
