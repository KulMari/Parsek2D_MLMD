...
results_dir='/l/users/s0198231/LHDI1836_2/' ; % directory for results
...
for i=1:Nprocs
 cart=hdf5read(['/l/users/s0198231/LHDI1836_1/proc',num2str(i-1),'.hdf'],'/topology/cartesian_coord');
 MAP(cart(1)+1,cart(2)+1)=hdf5read(['/l/users/s0198231/LHDI1836_1/proc',num2str(i-1),'.hdf'],'/topology/cartesian_rank')+1;
end
