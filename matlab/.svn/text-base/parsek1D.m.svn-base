%  parsek1D       -  Assemble hdf5 data for ParsekES 
%			  
%   parsek1D reads data saved in hdf5 from all processors and assemble them in the 
...
results_dir='/Users/markidis/parsek2D/results' ; % directory for results
...
variable_list='k_energy e_energy b_energy rho phi Ex';
